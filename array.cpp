...
int texto [] = {1,2,3}; // creamos el array texto
int opc [3]; // creamos el array opc para el menu
...
void menuArchivos(){
    ...
    cout<<texto[0]<<".-Crear nuevo archivo de datos"<<endl; // inicio del array de texto del menu
    cout<<texto[1]<<".-Utilizar uno hecho (introducir mas datos)"<<endl;
    cout<<texto[2]<<".-Ver los resultados del documento"<<endl; // fin del array texto del menu
    cin>>datos;
    switch(datos){
        case 1:
        archivoCreacion();
...
void introducirBoletos(){
    cout<<opc[0]<<".-adulto"<<endl; // inicio del array del menu opc
    cout<<opc[1]<<".-adulto mayor"<<endl;
    cout<<opc[2]<<".-niños"<<endl;
    cout<<"Introduce el tipo de boleto"<<endl; // fin del menu de array opc
    cin>>tipo_boleto;
